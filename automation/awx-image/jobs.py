...
class BaseTask(object):
    ...
    def write_inventory_file(self, inventory, private_data_dir, file_name, script_params):
        ...
        # Debug marker: best-effort write so we can detect which code path executed
        try:
            inv_id = getattr(inventory, 'id', None)
            with open('/tmp/awx_inventory_written_json', 'a') as _f:
